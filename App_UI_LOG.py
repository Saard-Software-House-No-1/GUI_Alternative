...
# Form implementation generated from reading ui file 'App_UI_LOG.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(190, 0, 750, 550))
...
"}")
        ...
        self.label_graph2_2 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.label_graph2_2.setMinimumSize(QtCore.QSize(0, 0))
        self.label_graph2_2.setMaximumSize(QtCore.QSize(170, 380))
        self.label_graph2_2.setStyleSheet("QLabel{ \n"
" \n"
" border-color: rgb(140, 140, 140);\n"
" border-radius:15;\n"
"    padding: 3px;\n"
...
" border-width: 2px;\n"
"}")
        self.label_graph2_2.setText("")
        self.label_graph2_2.setObjectName("label_graph2_2")
        self.gridLayout_2.addWidget(self.label_graph2_2, 0, 1, 1, 1)
        self.label_graph3_2 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.label_graph3_2.setMinimumSize(QtCore.QSize(0, 0))
        self.label_graph3_2.setMaximumSize(QtCore.QSize(170, 380))
...
"}")
        ...
        self.gridLayout_2.addWidget(self.label_graph3_2, 0, 2, 1, 1)
        self.label_Graph1_2 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.label_Graph1_2.setMinimumSize(QtCore.QSize(0, 0))
        self.label_Graph1_2.setMaximumSize(QtCore.QSize(170, 380))
        self.label_Graph1_2.setStyleSheet("QLabel{ \n"
" \n"
" border-color: rgb(140, 140, 140);\n"
" border-radius:15;\n"
"    padding: 3px;\n"
...
" border-width: 2px;\n"
"}")
        self.label_Graph1_2.setText("")
        self.label_Graph1_2.setObjectName("label_Graph1_2")
        self.gridLayout_2.addWidget(self.label_Graph1_2, 0, 0, 1, 1)
...
"}")
        ...
        self.radioButton_OT = QtWidgets.QRadioButton(self.Report)
        self.radioButton_OT.setGeometry(QtCore.QRect(450, 340, 82, 17))
        self.radioButton_OT.setObjectName("radioButton_OT")
        self.radioButton_Timeattendance = QtWidgets.QRadioButton(self.Report)
        self.radioButton_Timeattendance.setGeometry(QtCore.QRect(450, 370, 101, 17))
